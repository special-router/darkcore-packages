...
import (
	observatory "github.com/special-router/dcvpnupd/xray/observatory"
...
const file_app_observatory_command_command_proto_rawDesc = "" +
	...
	"\x11GetOutboundStatus\x12;.xray.core.app.observatory.command.GetOutboundStatusRequest\x1a<.xray.core.app.observatory.command.GetOutboundStatusResponse\"\x00B\x8a\x01\n" +
	"%com.xray.core.app.observatory.commandP\x01Z;github.com/special-router/dcvpnupd/xray/observatory/command\xaa\x02!Xray.Core.App.Observatory.Commandb\x06proto3"
